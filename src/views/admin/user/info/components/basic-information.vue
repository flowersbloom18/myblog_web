...
<script lang="ts" setup>
  ...
  const getData = async () => {
    try {
      ...
      if (!res.data.code) {
        data2.value[0].value = res.data.data.user_name;
        data2.value[1].value = res.data.data.nick_name;
        data2.value[2].value = res.data.data.avatar;
        // form.avatar = res.data.data.avatar;
        data2.value[3].value = res.data.data.email;
        data2.value[4].value = res.data.data.role;
        data2.value[5].value = res.data.data.ip;
        data2.value[6].value = res.data.data.address;
        data2.value[7].value = res.data.data.device;
        data2.value[8].value = res.data.data.register_origin;
        data2.value[9].value = res.data.data.created_at;
